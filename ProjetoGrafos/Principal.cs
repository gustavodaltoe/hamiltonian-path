...
namespace ProjetoGrafos
{
    ...
    public partial class Principal : Form
    {
        ...
        /// </summary>
        private void DrawGraph(EDA.Node[] highlightedNodes, EDA.Edge[] highlightedEdges = null)
        {
            List<EDA.Edge> edges = new List<EDA.Edge>();
        ...
        private void btnAddArc_Click(object sender, EventArgs e)
        {
            ...
            { 
                ...
                double cost = !String.IsNullOrEmpty(txtCost.Text.Trim()) ? Double.Parse(txtCost.Text) : 0;
                // Adiciona arco..
        ...
        {
            EDA.Edge[] hamiltonPath = this.graph.GetHamiltonPath();
            SetGraphControls(false);
            DrawGraph(null, hamiltonPath);
        }
    }
}
